...
1. (12 Pts) Region Counting:
	...
	- Any output images or files must be saved to "output/cellct" folder
 	...
 	b. (8 Pts) Write a program to perform blobcoloring. The input to your code should be a binary image (0's, and 255's) and the output should be a list of objects or regions in the image. 
